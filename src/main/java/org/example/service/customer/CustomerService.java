...
public interface CustomerService {
    ...
    void updateCustomer(String email, Customer customer) throws UnkownCustomerException, UnknownStoreException, UnknownAddressException, InvalidCustomerException;
}
